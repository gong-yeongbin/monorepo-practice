...
import CampaignTable from '@/features/advertising/campaigns/campaigns-table';
import CampaignForm from '@/features/advertising/campaigns/campaign-form';
import {
	Nav,
	NavBtn,
	NavLeft,
		...
		<PaddingContainer>
			...
			<Nav>
				...
				<NavRight>
					...
					<CampaignForm drawerVisible={drawerVisible} setDrawerVisible={setDrawerVisible} />
				</NavRight>
			</Nav>

...
export interface DailyDetailColumns {
	viewCode: string;
	pubId: string;
	subId: string;
	click: string;
...
const columnHelper = createColumnHelper<DailyDetailColumns>();
...
const DailyDetailTable = (props: {
	...
	const handleRowClick = (rowValues: DailyDetailColumns) => {

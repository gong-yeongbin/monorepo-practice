...
import InstallModal from '@/shared/ui/modals/install-modal';
import UnregisteredModal from '@/shared/ui/modals/unregistered-modal';
import EventModal from '@/shared/ui/modals/event-modal';
...
const columnHelper = createColumnHelper<DetailColumns>();

const DetailTable = (props: { data: Array<DetailColumns> }) => {
	const { data } = props;
	...
	const handleRowClick = (rowValues: DetailColumns) => {

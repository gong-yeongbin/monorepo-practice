...
@Module({
	...
	providers: [ListUserUseCase, GetUserUseCase, UpdateUserUseCase, UpdateUserPasswordUseCase, DeleteUserUseCase, { provide: USER_REPOSITORY, useClass: PrismaUserRepository }],
